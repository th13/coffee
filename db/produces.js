...
_.each(cps, function(plantation) {
	//randomly generate number of products a plantation produces (1 to 10)
	var numOfProducts = rand(0,10);

	for (var i = 0; i < numOfProducts; i++) {
		var productID = rand(0,199);
		produces.push([ plantation[0], productID ]);
	}
});
